...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <img class="profile-image img-responsive pull-left" src="aku.jpg" alt="Rahmat Shafari"  width="100px"/>
            <div class="profile-content pull-left">
                <h1 class="name">Rahmat Shafari</h1>
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">    
                            ...
                            <div class="item featured text-center">
                                <h3 class="title"><a href="https://wrapbootstrap.com/theme/delta-promote-mobile-app-effectively-WB09R23P8?ref=3wm" target="_blank">KickStarter - Potato Salad App</a></h3>
                                <p class="summary">A mobile app to help you make delicious potato salad</p>
                                ...
                                <a class="btn btn-cta-secondary" href="https://wrapbootstrap.com/theme/delta-promote-mobile-app-effectively-WB09R23P8?ref=3wm" target="_blank"><i class="fa fa-thumbs-o-up"></i> Back my project</a>                 
                            </div><!--//item-->
                            <hr class="divider" />
                            <div class="item row">
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-map-marker"></i><span class="sr-only">Location:</span>Menu</li>
                                <li><i class="fa fa-envelope-o"></i><span class="sr-only">About Me</span><a href="index.php?page=1">About Me</a></li>
                                <li><i class="fa fa-link"></i><span class="sr-only">Product:</span><a href="index.php?page=2">Product</a></li>
                            </ul>
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//aside-->
